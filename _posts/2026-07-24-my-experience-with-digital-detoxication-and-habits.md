...
The Unix philosophy tells: "Do one thing but do that thing very well". Minimalism. There's no time to assimilate things when you have a lot of external stimuli surrounding you. There's no time to think when there are a lot of noises in the background. There's no time to meditate, to code, to read, to note, to hack my Penfield homunculus if my mind wants a short-term reward. There's no time for you to do whatever you want to do if you prioritize short-term rewards. 
